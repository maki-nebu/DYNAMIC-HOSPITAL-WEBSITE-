            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="body">
                            @include('layouts.msg')
                            <form method="post" action="{{ route('admin.createHistory') }}" class="user" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <label>Image</label>
                                            <input type="file" class="form-control" placeholder="image" name="image" accept="image/jpeg, image/jpg, image/bmp, image/png, image/svg+xml, image/webp" >
                                        </div>
                                    </div>
                                </div>
